...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { slug: 'slider', text: 'Slider', render: sliderExample },
      { slug: 'color-picker', text: 'Color Picker', render: colorPickerExample },
      { slug: 'date-picker', text: 'Date Picker', render: datePickerExample },
      { slug: 'calendar', text: 'Calendar', render: calendarExample },
